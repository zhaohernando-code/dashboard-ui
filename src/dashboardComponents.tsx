  ...
  return (
    <Space direction="vertical" size={16} className="full-width">
      ...
      <TaskDetailModals
        ...
        activeLogTrack={activeLogTrack} setActiveLogTrack={setActiveLogTrack}
        cancelConfirmOpen={cancelConfirmOpen} setCancelConfirmOpen={setCancelConfirmOpen}
        acceptanceRejectModalOpen={acceptanceRejectModalOpen} setAcceptanceRejectModalOpen={setAcceptanceRejectModalOpen}
        acceptanceRejectFeedback={acceptanceRejectFeedback} setAcceptanceRejectFeedback={setAcceptanceRejectFeedback}
        isCancelPending={isCancelPending} isAcceptanceRejectPending={isAcceptanceRejectPending}
        trimmedAcceptanceRejectFeedback={trimmedAcceptanceRejectFeedback}
        logViews={logViews} logsLoading={logsLoading} logsError={logsError}
        normalizeDisplayText={normalizeDisplayText}
        taskExecutionMode={task.executionMode ?? ""}
        submitCancel={submitCancel} submitAcceptanceReject={submitAcceptanceReject}
      />
    </Space>
  );
}
