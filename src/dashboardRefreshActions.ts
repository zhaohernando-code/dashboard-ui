...
export function normalizeApiTask(task: Partial<Task>, locale: Locale): Task {
  ...
  const normalizedTask: Task = {
    ...
    logTotal: typeof task.logTotal === "number" ? task.logTotal : undefined,
    logLoadedFrom: typeof task.logLoadedFrom === "number" ? task.logLoadedFrom : undefined,
    logNextCursor: typeof task.logNextCursor === "number" ? task.logNextCursor : undefined,
    logTruncated: Boolean(task.logTruncated),
    logHasMore: Boolean(task.logHasMore),
